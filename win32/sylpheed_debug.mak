...
"$(INTDIR)\hooks.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\hooks.obj"	"$(INTDIR)\hooks.sbr" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
