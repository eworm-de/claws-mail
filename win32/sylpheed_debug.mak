...
!MESSAGE Keine Konfiguration angegeben. sylpheed - Win32 Debug wird als Standard verwendet.
!ENDIF 
...
ALL : "$(OUTDIR)\sylpheed_d.exe" "$(OUTDIR)\sylpheed_debug.bsc"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\sylpheed_debug.bsc"
...
LINK32=link.exe
LINK32_FLAGS=wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\sylpheed_d.pdb" /debug /machine:I386 /out:"$(OUTDIR)\sylpheed_d.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\about.obj" \
	"$(INTDIR)\account.obj" \
	"$(INTDIR)\addr_compl.obj" \
...
!IF EXISTS("sylpheed_debug.dep")
!INCLUDE "sylpheed_debug.dep"
!ELSE 
!MESSAGE Warning: cannot find "sylpheed_debug.dep"
!ENDIF 
!ENDIF 
