...
#ifdef WIN32
	from_str    = g_locale_from_utf8(from_str    ,-1, NULL, NULL, NULL);
	to_str      = g_locale_from_utf8(to_str      ,-1, NULL, NULL, NULL);
	subject_str = g_locale_from_utf8(subject_str ,-1, NULL, NULL, NULL);
	body_str    = g_locale_from_utf8(body_str    ,-1, NULL, NULL, NULL);
#endif
