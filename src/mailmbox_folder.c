...
static void *mmap_ro(const char *filename) {
	HANDLE file, map;
	void *view;
	...
	view = MapViewOfFileEx(map, FILE_MAP_READ, 0, 0, 0, NULL);
	if (!view)
		return MAP_FAILED;
	
	return view;
}
static gint munmap(void *start, size_t length) {
