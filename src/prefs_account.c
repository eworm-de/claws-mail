...
static void prefs_account_send_create(void)
{
	...
	/* CLAWS: SMTP AUTH */
	Xsend.smtp_auth_enable_login_chkbtn      = smtp_auth_enable_login_chkbtn;
	Xsend.smtp_auth_enable_cram_md5_chkbtn   = smtp_auth_enable_cram_md5_chkbtn;
	Xsend.smtp_auth_enable_digest_md5_chkbtn = smtp_auth_enable_digest_md5_chkbtn;
}
